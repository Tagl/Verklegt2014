...
Database::Database()
{
    ...
    {
        QSqlQuery query;
        query.exec("CREATE TABLE IF NOT EXISTS Computers (ID INT PRIMARY KEY  NOT NULL, Name VARCHAR,ComputerType VARCHAR, YearBuilt INT, WasMade VARCHAR, Description TEXT);");
